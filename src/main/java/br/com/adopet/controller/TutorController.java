...
public class TutorController {
    ...
    @PutMapping
    public ResponseEntity<DadosDetalhamentoTutor> atualizar(@RequestBody DadosAtualizacaoTutor DadosAtualizacaoTutor){
        DadosDetalhamentoTutor dadosDetalhamentoTutor = _tutorService.atualizar(DadosAtualizacaoTutor);
